...
from .datasets import (  # isort:skip
    ...
    TopDownPoseTrack18Dataset, TopDownPoseTrack18VideoDataset,BottomUpAnimalDataset)
...
__all__ = [
    ...
    'Compose', 'DistributedSampler', 'DATASETS', 'PIPELINES', 'DatasetInfo','BottomUpAnimalDataset'
]
